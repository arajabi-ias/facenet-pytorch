...
class InceptionResnetV1(nn.Module):
    ...
    """
    def __init__(self, pretrained=None, classify=False, num_classes=None, dropout_prob=0.6, device=None, ext_path=None):
        super().__init__()
        ...
        if self.classify and self.num_classes is not None:
            if pretrained == 'vggface2' or pretrained == 'casia-webface':
                ...
                self.logits = nn.Linear(512, self.num_classes)
                load_weights(self, pretrained, self.ext_path)
...
def load_weights(mdl, name, ext_path=None):
